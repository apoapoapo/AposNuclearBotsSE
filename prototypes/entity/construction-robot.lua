data:extend {
    ...
    },
    {
        ...
        working_light = { intensity = 0.8, size = 3 },
        idle = {
            filename = "__AposNuclearBotsSE__/graphics/entity/construction-robot/construction-robot-nuclear-fast.png",
            priority = "high",
            line_length = 16,
            width = 64,
            height = 72,
        ...
        shadow_idle = {
            filename = "__AposNuclearBotsSE__/graphics/entity/construction-robot/construction-robot-nuclear-shadow-fast.png",
            priority = "high",
            line_length = 16,
            width = 100,
            height = 48,
            frame_count = 1,
            shift = { 2.18750, 1.18750 },
            direction_count = 16,
        },
        shadow_in_motion = {
            filename = "__AposNuclearBotsSE__/graphics/entity/construction-robot/construction-robot-nuclear-shadow-fast.png",
        ...
        working = {
            filename = "__AposNuclearBotsSE__/graphics/entity/construction-robot/construction-robot-nuclear-working-fast.png",
            priority = "high",
            line_length = 2,
            width = 56,
            height = 72,
